...
echo "[0/6] Cleaning build directory..."
rm -rf $BUILD_DIR
mkdir -p $BUILD_DIR

echo "[1/6] Assembling bootloader..."
as --32 $SRC_DIR/bootsect.asm -o $BUILD_DIR/bootsect.o
ld -Ttext 0x7C00 -m elf_i386 --oformat binary \
   $BUILD_DIR/bootsect.o -o $BUILD_DIR/bootsect.bin
...
qemu-system-i386 -display sdl \
    -fda $BUILD_DIR/bootsect.bin \
    -fdb $BUILD_DIR/kernel.bin